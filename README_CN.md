...
- **24+ 维因子模型**：K 线动量、成交量分析、波动率、KDJ、MACD、RSI、布林带、行业分散度、综合信号等——通过 FactorRegistry 计算，带 IC 跟踪。
...
3. **因子注册表 (`factors/factor_registry.py`)**：24+ 维因子（动量、成交量、波动率、KDJ、MACD、RSI、布林带、行业分散度、综合信号），带 IC 跟踪与熔断保护。
